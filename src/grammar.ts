...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "BlockLevel", "symbols": ["BitOr"], "postprocess": id},
    {"name": "Paren", "symbols": [(nearleyLexer.has("lparen") ? {type: "lparen"} : lparen), "_", "BitOr", "_", (nearleyLexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d => d[2]},
