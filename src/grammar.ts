...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Unary", "symbols": [(nearleyLexer.has("add") ? {type: "add"} : add), "_", "Unary"], "postprocess": d => ["+", d[2]]},
    {"name": "Unary", "symbols": [(nearleyLexer.has("sub") ? {type: "sub"} : sub), "_", "Unary"], "postprocess": d => ["-", d[2]]},
    ...
    {"name": "Relational", "symbols": ["Relational", "_", (nearleyLexer.has("lt") ? {type: "lt"} : lt), "_", "BitShift"], "postprocess": d => [d[0], "<", d[4]]},
    {"name": "Relational", "symbols": ["Relational", "_", (nearleyLexer.has("gt") ? {type: "gt"} : gt), "_", "BitShift"], "postprocess": d => [d[0], ">", d[4]]},
    {"name": "Relational", "symbols": ["Relational", "_", (nearleyLexer.has("lte") ? {type: "lte"} : lte), "_", "BitShift"], "postprocess": d => [d[0], "<=", d[4]]},
    {"name": "Relational", "symbols": ["Relational", "_", (nearleyLexer.has("gte") ? {type: "gte"} : gte), "_", "BitShift"], "postprocess": d => [d[0], ">=", d[4]]},
    {"name": "Relational", "symbols": ["BitShift"], "postprocess": id},
    {"name": "Equality", "symbols": ["Equality", "_", (nearleyLexer.has("eq") ? {type: "eq"} : eq), "_", "Relational"], "postprocess": d => [d[0], "==", d[4]]},
    {"name": "Equality", "symbols": ["Equality", "_", (nearleyLexer.has("neq") ? {type: "neq"} : neq), "_", "Relational"], "postprocess": d => [d[0], "!=", d[4]]},
    {"name": "Equality", "symbols": ["Relational"], "postprocess": id},
    {"name": "BitAnd", "symbols": ["BitAnd", "_", (nearleyLexer.has("band") ? {type: "band"} : band), "_", "Equality"], "postprocess": d => [d[0], "&", d[4]]},
    {"name": "BitAnd", "symbols": ["Equality"], "postprocess": id},
    {"name": "BitXor", "symbols": ["BitXor", "_", (nearleyLexer.has("bxor") ? {type: "bxor"} : bxor), "_", "BitAnd"], "postprocess": d => [d[0], "^", d[4]]},
    {"name": "BitXor", "symbols": ["BitAnd"], "postprocess": id},
    {"name": "BitOr", "symbols": ["BitOr", "_", (nearleyLexer.has("bor") ? {type: "bor"} : bor), "_", "BitXor"], "postprocess": d => [d[0], "|", d[4]]},
    {"name": "BitOr", "symbols": ["BitXor"], "postprocess": id},
    {"name": "LogicAnd", "symbols": ["LogicAnd", "_", (nearleyLexer.has("and") ? {type: "and"} : and), "_", "BitOr"], "postprocess": d => [d[0], "&&", d[4]]},
    {"name": "LogicAnd", "symbols": ["BitOr"], "postprocess": id},
    {"name": "LogicOr", "symbols": ["LogicOr", "_", (nearleyLexer.has("or") ? {type: "or"} : or), "_", "LogicAnd"], "postprocess": d => [d[0], "||", d[4]]},
